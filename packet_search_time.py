...
class PacketSearchTimeCalculatorSimulated:
    def __init__(self, problems, packet_size):
        self.problems = problems
        self.packet_size = packet_size
...
if __name__ == '__main__':
    ...
    pst_fast = PacketSearchTimeCalculatorFast(problems, PACKET_SIZE)
    pst_sim = PacketSearchTimeCalculatorSimulated(problems, PACKET_SIZE)
    for _ in tqdm(range(ITERATIONS)):
        t_sim = pst_sim.get_packet_search_time(low, high)
